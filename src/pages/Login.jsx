        ...
        <div>
          <div className="mb-10">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-3xl font-extrabold tracking-tight">Reneal</span>
            </div>
            <div className="text-[11px] uppercase tracking-widest text-blue-300 mt-1.5">Warehouse System</div>
          </div>
